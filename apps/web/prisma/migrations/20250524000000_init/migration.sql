...
-- AddForeignKey
ALTER TABLE "SearchHistory" ADD CONSTRAINT "SearchHistory_savedContentId_fkey" FOREIGN KEY ("savedContentId") REFERENCES "SavedContent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
